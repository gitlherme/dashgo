          ...
          <Box as="form" onSubmit={handleSubmit(handleCreateUser)} flex="1" borderRadius={8} bg="gray.800" p="8">
            ...
            <VStack spacing="8">
              ...
              <SimpleGrid minChildWidth="240px" spacing="8" w="100%">
                ...
                <Input name="passwordConfirmation" error={errors.passwordConfirmation} type="password" label="Confirmar senha" {...register('passwordConfirmation')}/>
              </SimpleGrid>
            </VStack>
            ...
            <Flex justify="flex-end" mt="8">
              <HStack spacing="4">
                ...
                <Button type="submit" isLoading={formState.isSubmitting} colorScheme="pink" size="lg">
                  Salvar
                </Button>
              </HStack>
            </Flex>
